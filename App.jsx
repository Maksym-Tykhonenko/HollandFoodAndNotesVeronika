...
import {
    FoodinfoNotesEL,
    FoodhomeNotesEL,
    FooddutchrecipesNotesEL,
    FoodnewsNotesEL,
    FoodmyrecipesNotesEL,
    FoodcreaterecipeNotesEL,
    FoodreaddutchrecipeNotesEL,
    FoodreadmyrecipeNotesEL,
    FoodreadnewsNotesEL,
    FoodcaloriesNotesEL,
    FoodreadcaloriesNotesEL,
    FoodcreatecaloriesNotesEL,
    FoodnotesNotesEL,
    FoodcreatenoteNotesEL,
    FoodprofileNotesEL,
    FoodcreateprofileNotesEL
} from './FoodAndNotes/foodcnsts/appelnotes';
import { FoodsplashNotesEL } from './FoodAndNotes/foodcnsts/appelnotes';
import HollandFoodAndNotesProdScr from './FoodAndNotes/screens/HollandFoodAndNotesProdScr';
// libs
...
function App() {
  ...
  OneSignal.initialize('a220f626-8991-46c6-82ce-9868dcb0239a');
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2025-07-25T08:08:00'); //дата з якої поч працювати webView
  ...
  console.log('My product Url ==>', finalLink);
    ...
    const Route = ({ isFatch }) => {
            ...
            return (
                <Stack.Navigator>
                    <Stack.Screen
                        ...
                        name="HollandFoodAndNotesProdScr"
                        component={HollandFoodAndNotesProdScr}
        ...
        return (
            <Stack.Navigator
                initialRouteName="FoodinfoNotesEL"
                screenOptions={{ headerShown: false }}
            >
                <Stack.Screen
                    name="FoodsplashNotesEL"
                    component={FoodsplashNotesEL}
                />
                <Stack.Screen
                    name="FoodinfoNotesEL"
                    component={FoodinfoNotesEL}
                />
                <Stack.Screen
                    name="FoodhomeNotesEL"
                    component={FoodhomeNotesEL}
                />
                <Stack.Screen
                    name="FooddutchrecipesNotesEL"
                    component={FooddutchrecipesNotesEL}
                />
                <Stack.Screen
                    name="FoodnewsNotesEL"
                    component={FoodnewsNotesEL}
                />
                <Stack.Screen
                    name="FoodmyrecipesNotesEL"
                    component={FoodmyrecipesNotesEL}
                />
                <Stack.Screen
                    name="FoodcreaterecipeNotesEL"
                    component={FoodcreaterecipeNotesEL}
                />
                <Stack.Screen
                    name="FoodreaddutchrecipeNotesEL"
                    component={FoodreaddutchrecipeNotesEL}
                />
                <Stack.Screen
                    name="FoodreadmyrecipeNotesEL"
                    component={FoodreadmyrecipeNotesEL}
                />
                <Stack.Screen
                    name="FoodreadnewsNotesEL"
                    component={FoodreadnewsNotesEL}
                />
                <Stack.Screen
                    name="FoodcaloriesNotesEL"
                    component={FoodcaloriesNotesEL}
                />
                <Stack.Screen
                    name="FoodreadcaloriesNotesEL"
                    component={FoodreadcaloriesNotesEL}
                />
                <Stack.Screen
                    name="FoodcreatecaloriesNotesEL"
                    component={FoodcreatecaloriesNotesEL}
                />
                <Stack.Screen
                    name="FoodnotesNotesEL"
                    component={FoodnotesNotesEL}
                />
                <Stack.Screen
                    name="FoodcreatenoteNotesEL"
                    component={FoodcreatenoteNotesEL}
                />
                <Stack.Screen
                    name="FoodprofileNotesEL"
                    component={FoodprofileNotesEL}
                />
                <Stack.Screen
                    name="FoodcreateprofileNotesEL"
                    component={FoodcreateprofileNotesEL}
                />
            </Stack.Navigator>
        );
    };
