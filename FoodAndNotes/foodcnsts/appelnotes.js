...
export const FoodsplashNotesEL = () => {
  console.log('FoodsplashNotesEL');
  return <FoodsharedlayoutNotes el={<FoodsplashNotes />} />;
};

export const FoodinfoNotesEL = () => {
  return <FoodsharedlayoutNotes el={<FoodinfoNotes />} />;
};

export const FoodhomeNotesEL = () => {
  return <FoodsharedlayoutNotes el={<FoodhomeNotes />} navig />;
};

export const FooddutchrecipesNotesEL = () => {
  return <FoodsharedlayoutNotes el={<FooddutchrecipesNotes />} />;
};

export const FoodnewsNotesEL = () => {
  return <FoodsharedlayoutNotes el={<FoodnewsNotes />} />;
};

export const FoodmyrecipesNotesEL = () => {
  return <FoodsharedlayoutNotes el={<FoodmyrecipesNotes />} />;
};
...
export const FoodreadnewsNotesEL = ({ route }) => {
  ...
  return <FoodsharedlayoutNotes el={<FoodreadnewsNotes item={item} />} />;
};

export const FoodcaloriesNotesEL = () => {
  return <FoodsharedlayoutNotes el={<FoodcaloriesNotes />} navig />;
};

export const FoodreadcaloriesNotesEL = ({ route }) => {
  const { entry } = route.params;

  return <FoodsharedlayoutNotes el={<FoodreadcaloriesNotes entry={entry} />} />;
};
...
export const FoodnotesNotesEL = () => {
  return <FoodsharedlayoutNotes el={<FoodnotesNotes />} navig />;
};

export const FoodcreatenoteNotesEL = ({ route }) => {
  const { note } = route.params || {};

  return <FoodsharedlayoutNotes el={<FoodcreatenoteNotes note={note} />} />;
};

export const FoodprofileNotesEL = () => {
  return <FoodsharedlayoutNotes el={<FoodprofileNotes />} navig />;
};

export const FoodcreateprofileNotesEL = ({ route }) => {
  const { user } = route.params || {};

  return <FoodsharedlayoutNotes el={<FoodcreateprofileNotes user={user} />} />;
};
